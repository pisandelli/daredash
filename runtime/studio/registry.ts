...
export const STUDIO_TABS: StudioTabDefinition[] = [
  ...
  componentTab('button', 'primitive', {
    ...
    fields: [
      ...
      componentField('button.disabled.background-color', 'Disabled Background', 'color', 'Disabled'),
      componentField('button.disabled.color', 'Disabled Text', 'color', 'Disabled'),
      {
  ...
  componentTab('card', 'primitive', {
    ...
    fields: [
      ...
      componentField('card.padding', 'Default Section Padding', 'text', 'Layout'),
      componentField('card.header.padding', 'Header Padding', 'text', 'Header'),
      componentField('card.body.padding', 'Body Padding', 'text', 'Body'),
  ...
  componentTab('input', 'form', {
    ...
    fields: [
      ...
      componentField('input.required-marker.color', 'Required Marker Color', 'color', 'Label'),
  ...
  componentTab('radio', 'form', {
    ...
    fields: [
      ...
      componentField('radio.disabled.dot-color', 'Disabled Dot Color', 'color', 'States'),
  ...
  componentTab('table', 'widget', {
    ...
    fields: [
      ...
      componentField('table.header.font-size', 'Header Font Size', 'text', 'Header'),
      ...
      componentField('table.cell.font-size', 'Cell Font Size', 'text', 'Cell'),
      ...
      componentField('table.density.large.header.font-size', 'Large Header Size', 'text', 'Density'),
      componentField('table.density.large.header.padding', 'Large Header Padding', 'text', 'Density'),
      componentField('table.density.large.cell.font-size', 'Large Cell Size', 'text', 'Density'),
      componentField('table.density.large.cell.padding', 'Large Cell Padding', 'text', 'Density'),
      componentField('table.density.comfortable.header.font-size', 'Comfortable Header Size', 'text', 'Density'),
      componentField('table.density.comfortable.header.padding', 'Comfortable Header Padding', 'text', 'Density'),
      componentField('table.density.comfortable.cell.font-size', 'Comfortable Cell Size', 'text', 'Density'),
      componentField('table.density.comfortable.cell.padding', 'Comfortable Cell Padding', 'text', 'Density'),
      componentField('table.density.compact.header.font-size', 'Compact Header Size', 'text', 'Density'),
      componentField('table.density.compact.header.padding', 'Compact Header Padding', 'text', 'Density'),
      componentField('table.density.compact.cell.font-size', 'Compact Cell Size', 'text', 'Density'),
      componentField('table.density.compact.cell.padding', 'Compact Cell Padding', 'text', 'Density'),
      componentField('table.row.background-color', 'Row Background', 'color', 'Rows'),
